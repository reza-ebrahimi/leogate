 ...
 */
ROSCPP_DECL const char *ros_master_getHost();
 ...
 */
ROSCPP_DECL const char *ros_master_getURI();
 ...
 */
ROSCPP_DECL const char *ros_master_getTopics();

/**
 * \brief Retreives the currently-known list of nodes from the master
 */
ROSCPP_DECL const char *ros_master_getNodes();
